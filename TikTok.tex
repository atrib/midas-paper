...
\begin{enumerate}
  ...
  \item \label{attk:swap} \emph{\atri{Frankenstein double fetch}}: The adversary
...
>>>>>>> Added impl of file-system writes
...
When writing to pages in the page cache, FS driver will access the 
...
\Code{mmap} with \Code{MAP_POPULATE}, or just on later access.
\Code{clone}.
