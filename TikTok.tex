...
% A really high level overview of how the system worls
...
bypassing the protections\pra{Aren't 'attacks' and 'ways of bypassing protections' equivalent? I suggest
just using one term}. The following attacks are possible:
...
% A brief overview of the main mechanism so the simplistic example is easier
% to follow
...
is one of the contributions of the paper\pra{This flow is awkward. Don't just explicitly call finding this vector
...
space. We will refer to this data structure as the interval-tree\pra{As a general rule, save
implementation details such as types of data structures used for the implementation section}, considering
