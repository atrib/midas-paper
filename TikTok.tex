...
workloads. On system call heavy workloads, \tiktok incurs 0.2-14\%
...
syscalls which require exemption from \tiktok's protection, and 
...
benefit from \tiktok's protection.
...
\end{inparaenum}
\tiktok ensures that both fetches return \Code{X=(42,0)}.
...
With \tiktok enabled, the exploit was never triggered, i.e., both fetches 
...
for these workloads.
\autoref{fig:tiktok_performance} shows \tiktok's performance (time/operation) 
...
\autoref{fig:tiktok_performance} shows \tiktok's performance for both MPI and OpenMP,
...
these benchmarks in \autoref{fig:tiktok_performance}, roughly ordering 
