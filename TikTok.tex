...
For verifying \tiktok's defense, we introduce a check condition into the 
...
\begin{figure}
  ...
  \caption{Classification of overheads for }
...
workloads. 
As expected, metadata tracking and duplication causes significant overheads
