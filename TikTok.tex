...
\newcommand{\nb}[1]{\textcolor{purple}{\textbf{NB}: #1}}
...
System calls may contain vulenerable code that a \pra{Synonyms seem redundant and
...
system call based on the ID \pra{What do you mean by `ID of the call`? Function name? Clarify.} 
