...
$18\%$ overhead for the nginx benchmark, while protecting the kernel against
any \tocttou attacks. On average, \tiktok shows a $4.3\%$ overhead on 
...
\section{Evaluation}
%%%%%%%%%%%%%%%%%%%%
\atri{Add average bars on plots}
