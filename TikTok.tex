...
\mat{user or kernel?} thread would
...
\begin{LaTeXdescription}
  ...
  as \texttt{write} and its variants. The code of these frequent system calls
  has been checked for double-fetches in previous work~\cite{wang2017double,
  xu2018precise}.
