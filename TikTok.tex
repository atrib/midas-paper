...
\begin{enumerate}
  ...
  vulnerable data. This attack does not use store instructions in any 
  CPU core. Alternately, the page could be a device-backed page using 
  memory-mapped I/O. In this case, the contents of the vulnerable 
  data can change due to external changes to the device's state.
