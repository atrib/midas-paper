...
To better understand the \tiktok's behavior under varying syscall 
...
Under a saturated network, the request rates with \tiktok match that 
...
scalability of Linux' networking stack.
