...
\mat{This section misses an introduction paragraph. What kind of background do
you want to tell us. Why is it important? Why should we care?}
...
\mat{In my group we're using \autoref{subsec:ipc}. Also, watch out for the - to
--- again.}
...
\mat{When you cite, make sure to have a space between last word and citation:
foo~\cite{bla}.}

\mat{These paragraphs are a little too basic and can be summarized in a sentence
or two. Either you explain why they are important in your context or you drop
them.}
...
\mat{likely way too high level. this is all common knowledge, focus more on the
kernel aspects that you may need.}
...
\mat{fold into previous, again too high level}
...
\mat{or?}
\mat{too high level. summarize the last 3 subsections into one.}
...
\mat{This section starts very differently from what I expected. Talk about the
copy from/to part first, not swapping! Why would you talk about swapping?}
\mat{First paragraph should ease into the section and connect to the details
...
\mat{Again, cites need a non-breaking space before them:~\cite{foo}}
...
\mat{Threat model? and add it as a section before.}

\mat{Again, I expect something very different from a threat model. Focus on what
is needed and what the attacker can do.}
...
\end{enumerate}
\mat{make these high level design requirements}
